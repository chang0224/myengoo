...
- 본문: "technology may slow **cognitive** decline in older adults"
...
B2+ 단어와 핵심 표현만. 단어 암기·Anki 변환 등에 쓰기 편하도록 원문·직독직해 없음.
...
직독직해 + 단어장 + 핵심 표현 모두 포함. 이 파일이 실제 학습의 메인입니다 (기존 단일 출력 구조).
...
- [ ] 모든 단어에 IPA · 품사 · 한국어 뜻 · 본문 · 예문이 있는가
